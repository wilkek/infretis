...
def retis_swap_zero(
    ...
    print('name', path_tmp)
    print('name2', ens_set0)
    print( 'name3', shpt_copy )
    randint = np.random.randint(100000, 1000000)
    engine1.dump_phasepoint(phase_point, ens_set0, f"second_{randint}")
    ...
    if allowed:
        ...
        # engine0.dump_phasepoint(phase_point, ens_set0, f"second_last")
        randint = np.random.randint(100000, 1000000)
        engine0.dump_phasepoint(phase_point, ens_set0, f"second_last_{randint}")
